  ...
  render () {
    ...
    return  <div className="welcome-bar-container">
              <div className="welcome-bar">
                ...
                <p>Pomodoro.cc is a tool that leverages the concepts of the <a href="http://pomodorotechnique.com/" target="_blank">Pomodoro Technique</a> to help you to keep your focus, get things done with frequent, mind-refreshing breaks.</p>
