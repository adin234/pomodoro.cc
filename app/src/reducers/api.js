...
export default function api(state=initialState, action) {
  switch(action.type){
    ...
    case GET_POMODORI_SUCCESS: {
      return {
        ...state,
        pomodori: action.payload
      }
    }
    case GET_POMODORI_ERROR: {
      if( window.development ){
        return {
          ...state,
          pomodori: dummyDaysPomodori()
        }
      }
      return state
    }
